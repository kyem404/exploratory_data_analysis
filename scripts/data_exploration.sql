...
-- Top 5 product that perform the worst
SELECT TOP 5
p.product_name,
SUM(f.sales_amount) total_revenue
FROM gold.fact_sales f
...
-- Top 5 subcategories that generate the highest revenue
SELECT TOP 5
p.subcategory,
SUM(f.sales_amount) total_revenue
FROM gold.fact_sales f
...
-- Top 10 customers who have generated the highest revenue + 3 customers with the fewest orders placed
SELECT TOP 10
c.customer_key,
c.first_name,
c.last_name,
